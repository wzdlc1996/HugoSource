...
6. `Linear operator` : $\ket{\psi_1}\bra{\psi_2}$ with $\psi_i\in\mathcal{H}_i$ is a linear operator : $\mathcal{H}_2\rightarrow \mathcal{H}_1 , \ket{\phi}\mapsto \ket{\psi_1}\langle \psi_2 | \phi\rangle$
